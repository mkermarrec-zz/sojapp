...
public class CustomBlob implements BinaryField, UserType {
    ...
    private CustomBlob(String UUID, String type) {
        this.UUID = UUID;
        this.type = type;
    }
    ...
    public boolean equals(Object o, Object o1) throws HibernateException {
        if(o instanceof CustomBlob && o1 instanceof CustomBlob) {
            return equal(((CustomBlob)o).UUID, ((CustomBlob)o1).UUID) &&
                    equal(((CustomBlob)o).type, ((CustomBlob)o1).type);
        }
        return equal(o, o1);
    }
    ...
    public Object nullSafeGet(ResultSet resultSet, String[] names, SessionImplementor sessionImplementor, Object o) throws HibernateException, SQLException {
        ...
        if(val == null || val.length() == 0 || !val.contains("|")) {
            return new CustomBlob();
        }
        return new CustomBlob(val.split("[|]")[0], val.split("[|]")[1]);
    }
    ...
    public void nullSafeSet(PreparedStatement ps, Object o, int i, SessionImplementor sessionImplementor) throws HibernateException, SQLException {
        if(o != null) {
            ps.setString(i, ((CustomBlob)o).UUID + "|" + ((CustomBlob)o).type);
        } else {
    ...
    public Object deepCopy(Object o) throws HibernateException {
        ...
        return new CustomBlob(((CustomBlob)o).UUID, ((CustomBlob)o).type);
    }
